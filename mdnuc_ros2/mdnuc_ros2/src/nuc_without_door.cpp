...
namespace nuc_ros2
{
	...
	std::pair<std::vector<int>, std::vector<double> > nuc(const std::vector<int>& mesh_tri, const std::vector<double>& mesh_ver, int initial_tri_index,  const std::set<std::pair<int, int>>& ignored_edges)
    {
    ...
    std::pair<std::vector<int>, std::vector<double> > nuc(const std::vector<int>& mesh_tri, const std::vector<double>& mesh_ver,  const std::set<std::pair<int, int>>& ignored_edges)
	{		
		...
		return nuc(mesh_tri, mesh_ver, initial_tri_index, ignored_edges);
	}
		...
		std::shared_ptr<mdnuc_msgs::srv::GetNuc::Response> response)
	{
		...
		{
			std::cout << "Processing edge: p1(" << edge.p1.x << ", " << edge.p1.y << ", " << edge.p1.z 
				<< "), p2(" << edge.p2.x << ", " << edge.p2.y << ", " << edge.p2.z << ")";
		...
		std::cout << "\nIgnored edges: " << ignored_edges.size();

		result = nuc(mesh_tri, mesh_ver, ignored_edges);
		...
		std::shared_ptr<mdnuc_msgs::srv::GetNucWithGivenStart::Response> response)
	{
		...
		result = nuc(mesh_tri, mesh_ver, min_facet, ignored_edges);
