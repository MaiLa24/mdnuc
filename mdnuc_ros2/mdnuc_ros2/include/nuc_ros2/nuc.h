...
#include <mdnuc_msgs/srv/get_nuc.hpp>
#include <mdnuc_msgs/srv/get_nuc_with_given_start.hpp>
...
namespace mdnuc_ros2
{
	...
	class NUC: public rclcpp::Node
	{
		public:
			...
			void getNUCCallback(const std::shared_ptr<mdnuc_msgs::srv::GetNuc::Request> request, 
				std::shared_ptr<mdnuc_msgs::srv::GetNuc::Response> response);

			void getNUCWithStartCallback(const std::shared_ptr<mdnuc_msgs::srv::GetNucWithGivenStart::Request> request, 
				std::shared_ptr<mdnuc_msgs::srv::GetNucWithGivenStart::Response> response);

		private:

			rclcpp::Service<mdnuc_msgs::srv::GetNucWithGivenStart>::SharedPtr nuc_with_start_service_;

			rclcpp::Service<mdnuc_msgs::srv::GetNuc>::SharedPtr nuc_service_;
