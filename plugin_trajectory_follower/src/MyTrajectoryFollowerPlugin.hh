 ...
 *
 */
 #ifndef GZ_SIM_SYSTEMS_MyTrajectoryFollower_HH_
 #define GZ_SIM_SYSTEMS_MyTrajectoryFollower_HH_
 ...
 {
   // Forward declaration
   class MyTrajectoryFollowerPrivate;
   ...
   //   name="gz::sim::systems::MyTrajectoryFollower">
   ...
   //   </circle>
   // </plugin>
   class MyTrajectoryFollower
       : public System,
         public ISystemConfigure,
         public ISystemPreUpdate
   {
     /// \brief Constructor
     public: MyTrajectoryFollower();
 
     /// \brief Destructor
     public: ~MyTrajectoryFollower() override = default;
     ...
     private: std::unique_ptr<MyTrajectoryFollowerPrivate> dataPtr;
   };
   }
 }
 }
